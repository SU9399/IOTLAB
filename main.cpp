...
const char *password = "yDt54e4QUYMaeaL97VX5"; // put in WIFI password

// MQTT
MqttClient mqttClient(wifiClient);
const char broker[] = "10.24.2.97";           // MQTT Broker FQDN, will be provided in lab
int port = 1883;                                  // MQTT Port
const char topic[] = "THM/IoTLab/Sulaiman/BME680"; // MQTT Topic
// BME680
